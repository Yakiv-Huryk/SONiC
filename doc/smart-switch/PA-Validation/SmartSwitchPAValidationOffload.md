...
- [2 Modules Design](#2-modules-design)
  - [2.1 Dash Offload Manager](#22-dash-offload-manager)
    - [2.1.1 SONiC GNMI server changes](#221-sonic-gnmi-server-changes)
  - [2.2 PA Validation Offload](#23-pa-validation-offload)
    - [2.2.1 PA Validation Offload ACL configuration](#231-pa-validation-offload-acl)
  - [2.3 DPU Shut/Restart](#24-dpu-shutrestart)
